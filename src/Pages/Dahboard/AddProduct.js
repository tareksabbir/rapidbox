            ...
            <div className="bg-white py-6 sm:py-8 lg:py-6 lg:mb-10 lg:mt-5 lg:ml-52">
                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    ...
                    <div className="mb-10 md:mb-10">
                        <h2 className="text-gray-800 text-2xl lg:text-4xl font-bold  mb-4 md:mb-4 lg:mb6">Add New Product Here</h2>
                    </div>

                    <form onSubmit={productHandle} className="max-w-screen-md grid sm:grid-cols-2 gap-4 ">
                        <div>
                            <label className="inline-block text-gray-800 text-sm sm:text-base mb-2">Admin Name*</label>
                        ...
                        <div>
                            <label className="inline-block text-gray-800 text-sm sm:text-base mb-2"> Admin Email*</label>
                        ...
                        <div>
                            <label className="inline-block text-gray-800 text-sm sm:text-base mb-2">Minimum Order*</label>
                        ...
                        <div >
                            <label className="inline-block text-gray-800 text-sm sm:text-base mb-2">Available Quantity*</label>
