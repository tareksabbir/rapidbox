                ...
                <div class="bg-white py-6 sm:py-8 lg:py-12">
                    <div class="max-w-screen-lg px-4 md:px-8 mx-auto">
                        <div class="grid md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-100 rounded-lg overflow-hidden relative lg:mt-14">
                                    <img src={product.img} loading="lazy" alt="" class="w-full h-full object-cover object-center" />
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="mb-2 md:mb-3">
                                    <span class="inline-block text-gray-500 mb-0.5">Best Selling</span>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex items-end gap-2">
                                        <span class="text-gray-800 text-xl md:text-2xl font-bold">${product.price}<span className='text-sm'>/per pice</span></span>
                                ...
                                <div class="flex items-center text-gray-500 gap-2 mb-6">
                                    ...
                                    <span class="text-sm">20-40 day shipping</span>
                                </div>

                                <div class="flex gap-2.5">
                                    <a href={`/order/${product._id}`} class="inline-block flex-1 sm:flex-none bg-primary hover:bg-secondary active:bg-secondary focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Order Now</a>
