                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div>
                            <div class="border rounded-lg p-4">
                                ...
                                <span class="block text-gray-500 text-sm">Bases on 33k+ reviews</span>
                                ...
                                <a href="/dashboard/reviews" class="block bg-white hover:bg-gray-100 active:bg-gray-200 focus-visible:ring ring-indigo-300 border text-gray-500 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 md:px-8 py-2 md:py-3">Write a review</a>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="divide-y">

                                {
                                    [...reviews].reverse().map(review => <div
                                        ...
                                        <div>
                                            <span class="block text-sm font-bold">{review.name}</span>
                                            <span class="block text-gray-500 text-sm">Date : {review.date} </span>
                                        </div>


                                        <div class="flex gap-0.5 -ml-1 items-center">
                                            <span>{review.stars}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                            </svg>
                                        </div>
                                        <p class="text-gray-600">{review.massage}</p>
                                    </div>)
                                }
                            ...
                            <div class="border-t pt-6">
                                <a href="/" class="flex items-center text-indigo-400 hover:text-indigo-500 active:text-indigo-600 font-semibold transition duration-100 gap-0.5">Read all reviews</a>
                            </div>
                        </div>
